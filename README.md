...
- 🥚 **Easter egg** — hover over "Page Language" for 5 seconds to reveal a surprise message
...
- 🥚 **イースターエッグ** — 「ページ言語」に5秒間マウスを乗せるとサプライズ文字が表示
...
- 🥚 **이스터에그** — "페이지 언어"에 5 초간 마우스를 올리면 깜짝 문구 표시
...
- 🥚 **Пасхалка** — наведите на «Язык страницы» на 5 секунд для сюрприза
...
- 🥚 **بيضة عيد الفصح** — مرر الماوس فوق "لغة الصفحة" لمدة 5 ثوانٍ
...
- 🥚 **Œuf de Pâques** — survolez « Langue de la page » pendant 5 secondes pour une surprise
...
- 🥚 **Huevo de Pascua** — mantén el cursor sobre "Idioma de la página" durante 5 segundos para una sorpresa
...
- 🥚 **Easter Egg** — Bewegen Sie den Mauszeiger 5 Sekunden über „Seitensprache" für eine Überraschung
...
- 🥚 **Easter Egg** — passe o mouse sobre "Idioma da página" por 5 segundos para uma surpresa
